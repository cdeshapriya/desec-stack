...
export default {
  ...
  data() {
    ...
    return {
        ...
        texts: {
          ...
          create: () => self.limit_domains ? `You have ${self.availableCount} of ${self.limit_domains} domains left.<br /><small>Contact support to apply for a higher limit.</small>` : '',
  ...
  computed: {
    ...
    availableCount: function () {
      return this.limit_domains ? Math.max(this.limit_domains - this.rows.length, 0) : Infinity;
    },
